...
>
  ...
  <main class="w-full max-w-4xl xl:max-w-6xl m-auto px-8">
    ...
    <div class="mt-12">
      <div class="relative">
        <hr class="text-neutral-200 bg-neutral-200 h-[3px]" />
        <p
          class="text-base font-medium absolute -top-3 left-1/2 -translate-x-1/2 bg-neutral-50 text-neutral-200 uppercase px-4"
        >
          Connect
        </p>
      </div>
      <div class="flex items-center justify-center gap-12 mt-8">
        ...
        >
          ...
          <svg
            ...
            class="w-12 cursor-pointer stroke-neutral-200 hover:stroke-neutral-400 fill-neutral-200 hover:fill-neutral-400 transition duration-200 ease-in-out"
            viewBox="0 0 128 128"
            id="discord"
            stroke-width={3}
            ><path
        ...
        >
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            stroke-width="1.5"
            class="w-12 fill-neutral-200 hover:fill-neutral-400 cursor-pointer transition duration-200 ease-in-out"
          >
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
